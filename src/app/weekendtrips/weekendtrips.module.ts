...
@NgModule({
  ...
  declarations: [WeekendTripComponent,UpdateUserComponent, CityComponent, PackageComponent,NumberCustomValidatorDirective, LoginComponent,ResetPasswordComponent, TravellerComponent, ResetPasswordComponent,SearchPipe, UserdetailsComponent,PlacesComponet,BookingreviewComponent,ContactComponent,AboutComponent,PaymentComponent],
  exports: [CityComponent, WeekendTripComponent, PackageComponent, LoginComponent, TravellerComponent,NumberCustomValidatorDirective, SearchPipe, UserdetailsComponent,PlacesComponet,BookingreviewComponent,ContactComponent,AboutComponent,PaymentComponent]
